"""
Data Transformation (Handling Missing Values, Feature Scaling,handling categorical  features, numerical features, handling outlier feature Engineering)
   Input: Train Data and Test Data
   Output:
   1. Transformed Data
   2. Pickle file( Pipeline pickle file (model which we create , save into hard disk))...This will also be saved in artifacts
      pipeline pickle file..categorical and numerical pipeline. this file we need to save in artifacts folder
      Serialized path
